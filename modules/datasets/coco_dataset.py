...
class CocoDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        img_meta = {}
        img_meta["boxes"] = torch.as_tensor(ann_info['bboxes'], dtype=torch.float32)
        img_meta["labels"] = torch.as_tensor(ann_info['labels'], dtype=torch.int64)

        img_meta["image_id"] = torch.tensor([img_info['id']])
        # img_meta["area"] = img_info['file_name']
        # img_meta["iscrowd"] = img_info['file_name']
    ...
    def get_ann_info(self, idx):
        ...
        return self._parse_ann_info(self.data_infos[idx], ann_info)#是否满足宽高面积等条件
